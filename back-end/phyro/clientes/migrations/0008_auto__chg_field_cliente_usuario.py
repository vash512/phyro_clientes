...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cliente.usuario'
        db.alter_column(u'clientes_cliente', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Cliente.usuario'
        db.alter_column(u'clientes_cliente', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User'], unique=True))
