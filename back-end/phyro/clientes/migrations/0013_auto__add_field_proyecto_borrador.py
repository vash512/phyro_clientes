...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proyecto.borrador'
        db.add_column(u'clientes_proyecto', 'borrador',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proyecto.borrador'
        db.delete_column(u'clientes_proyecto', 'borrador')
    ...
    models = {
        ...
        u'clientes.proyecto': {
            ...
            'borrador': ('django.db.models.fields.BooleanField', [], {}),
