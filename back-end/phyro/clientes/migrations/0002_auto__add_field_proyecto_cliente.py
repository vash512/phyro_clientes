...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proyecto.cliente'
        db.add_column(u'clientes_proyecto', 'cliente',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clientes.Cliente'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proyecto.cliente'
        db.delete_column(u'clientes_proyecto', 'cliente_id')
