...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UrlProyecto'
        db.create_table(u'clientes_urlproyecto', (
        ...
        db.send_create_signal(u'clientes', ['UrlProyecto'])

        # Adding field 'Proyecto.otrRec'
        db.add_column(u'clientes_proyecto', 'otrRec',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UrlProyecto'
        db.delete_table(u'clientes_urlproyecto')

        # Deleting field 'Proyecto.otrRec'
        db.delete_column(u'clientes_proyecto', 'otrRec')
