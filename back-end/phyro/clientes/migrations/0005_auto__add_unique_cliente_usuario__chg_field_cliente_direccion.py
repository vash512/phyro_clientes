...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Cliente', fields ['usuario']
        db.create_unique(u'clientes_cliente', ['usuario_id'])


        # Changing field 'Cliente.direccion'
        db.alter_column(u'clientes_cliente', 'direccion', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'Cliente', fields ['usuario']
        db.delete_unique(u'clientes_cliente', ['usuario_id'])


        # Changing field 'Cliente.direccion'
        db.alter_column(u'clientes_cliente', 'direccion', self.gf('django.db.models.fields.TextField')(default=' '))
