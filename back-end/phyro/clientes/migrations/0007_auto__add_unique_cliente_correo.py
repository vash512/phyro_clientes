...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Cliente', fields ['correo']
        db.create_unique(u'clientes_cliente', ['correo'])


    def backwards(self, orm):
        # Removing unique constraint on 'Cliente', fields ['correo']
        db.delete_unique(u'clientes_cliente', ['correo'])
