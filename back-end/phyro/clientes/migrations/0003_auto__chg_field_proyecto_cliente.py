...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proyecto.cliente'
        db.alter_column(u'clientes_proyecto', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Proyecto.cliente'
        db.alter_column(u'clientes_proyecto', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clientes.Cliente'], null=True))
