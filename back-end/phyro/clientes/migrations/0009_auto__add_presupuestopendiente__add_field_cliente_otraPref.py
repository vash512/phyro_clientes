...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PresupuestoPendiente'
        db.create_table(u'clientes_presupuestopendiente', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proyecto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clientes.Proyecto'])),
            ('registro', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'clientes', ['PresupuestoPendiente'])

        # Adding field 'Cliente.otraPref'
        db.add_column(u'clientes_cliente', 'otraPref',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PresupuestoPendiente'
        db.delete_table(u'clientes_presupuestopendiente')

        # Deleting field 'Cliente.otraPref'
        db.delete_column(u'clientes_cliente', 'otraPref')
    ...
    models = {
        ...
        u'clientes.presupuestopendiente': {
            'Meta': {'object_name': 'PresupuestoPendiente'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['clientes.Proyecto']"}),
            'registro': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'clientes.proyecto': {
